      ...
      <div className='w-full max-w-md'>
        ...
        <div className='bg-white rounded-2xl shadow-glass p-8 border border-clinic-navy/5'>
          <div className='text-center mb-8'>
            <div className='w-16 h-16 mx-auto mb-4 rounded-2xl bg-clinic-ai/10 flex items-center justify-center'>
          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <div className='space-y-2'>
              ...
              <Textarea
                ...
                className='min-h-[100px] border-clinic-navy/10 resize-none'
              />
            </div>
