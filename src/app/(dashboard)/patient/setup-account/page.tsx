...
export default function SetupPatientAccount() {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      ...
      if (user?.user_metadata) {
        ...
        setPatientName(`${first} ${last}`.trim());
        setClinicName(user.user_metadata.invited_by_clinic_name || '');
      }
    };
        ...
        <div className="bg-white rounded-2xl shadow-glass p-8 border border-clinic-navy/5">
          <div className="text-center mb-8">
            <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-clinic-teal/10 flex items-center justify-center">
              <User className="w-8 h-8 text-clinic-teal" />
            </div>
