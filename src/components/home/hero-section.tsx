  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute bottom-1/4 right-20 w-16 h-16 bg-clinic-ai/10 rounded-full animate-float"
          style={{ animationDelay: "2s" }}
        />
        <div
          className="absolute top-1/3 right-1/4 w-12 h-12 bg-clinic-navy/10 rounded-xl rotate-45 animate-float"
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="max-w-2xl">
            ...
            >
              ...
              AI-Powered Clinic Operating System
            </Badge>
            ...
            >
              Manage appointments, patient records, staff schedules, billing,
              and AI-powered clinical notes — all in one secure platform.
              Replace Messenger, Viber, Excel, and paper charts forever.
            </p>
            ...
            >
              <Button
                size="lg"
                className="bg-clinic-teal hover:bg-clinic-teal/90 text-white px-8 h-14 text-base shadow-glow hover:shadow-lg transition-all duration-300 group"
                asChild
              >
                <Link href="/register">
                  Start Free Trial
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-clinic-navy/20 text-clinic-navy dark:border-white/20 dark:text-white px-8 h-14 text-base hover:bg-clinic-navy/5 dark:hover:bg-white/5 transition-all duration-300"
                asChild
              >
                <Link href="/demo">
          ...
          <div ref={visualRef} className="relative lg:h-[600px]">
            <div className="relative h-full">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-glass-lg border border-white/50 dark:border-slate-700/50 bg-white dark:bg-slate-800">
                {/* Fake browser chrome */}
                <div className="flex items-center gap-2 px-4 py-3 bg-clinic-navy/5 dark:bg-slate-700/50 border-b border-clinic-navy/10 dark:border-white/10">
                  ...
                  <div className="flex-1 mx-4">
                    <div className="h-6 bg-clinic-navy/5 dark:bg-white/10 rounded-md flex items-center px-3">
                      <span className="text-[10px] text-clinic-text/40 dark:text-white/40 font-mono">
                        app.mediflow.ai/dashboard
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      ...
                      <div
                        key={stat.label}
                        className="p-3 rounded-xl bg-clinic-bg dark:bg-slate-700/50 border border-clinic-navy/5 dark:border-white/5"
                      >
                        <div className="flex items-center justify-between mb-2">
                          <stat.icon className="w-4 h-4 text-clinic-teal" />
                          <span className="text-[10px] text-clinic-teal font-semibold">
                            {stat.change}
                          </span>
                        </div>
                        <p className="text-lg font-display font-bold text-clinic-navy dark:text-white">
                          {stat.value}
                        </p>
                        <p className="text-[10px] text-clinic-text/50 dark:text-white/50">
                          {stat.label}
                        </p>
                      </div>
                    ))}
                  ...
                  {/* Appointments list */}
                  <div className="p-3 rounded-xl bg-clinic-bg dark:bg-slate-700/50 border border-clinic-navy/5 dark:border-white/5">
                    <p className="text-xs font-semibold text-clinic-navy dark:text-white mb-2">
                    ...
                    {[
                      ...
                      <div
                        key={apt.name}
                        className="flex items-center justify-between py-2 border-b border-clinic-navy/5 dark:border-white/5 last:border-0"
                      >
                        <div className="flex items-center gap-2">
                          <div className="w-7 h-7 rounded-full bg-gradient-to-br from-clinic-teal to-clinic-ai flex items-center justify-center">
                          ...
                          <div>
                            <p className="text-[11px] font-semibold text-clinic-navy dark:text-white">
                              {apt.name}
                            </p>
                            <p className="text-[9px] text-clinic-text/50 dark:text-white/50">
                              {apt.type}
                            </p>
                          </div>
                        </div>
                        <span className="text-[10px] font-medium text-clinic-teal">
                          {apt.time}
                        </span>
                      </div>
                    ))}
              ...
              <div className="absolute -top-4 -right-4 lg:right-8 p-4 rounded-xl glass-card shadow-glass animate-float max-w-[200px]">
                ...
                <p className="text-xs text-clinic-text/70 dark:text-white/70">
                  &quot;Consultation summary generated for Maria Santos...&quot;
                </p>
              </div>
