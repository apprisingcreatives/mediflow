...
export function RescheduleModal({ appointment, isOpen, onClose }: RescheduleModalProps) {
  ...
  }, [selectedDate, appointment.practitioner_id, appointment.id, durationMinutes]);
