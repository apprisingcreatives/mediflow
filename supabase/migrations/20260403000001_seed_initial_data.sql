...
('Starter', 'starter', 5000, 'PHP', 'monthly', 'Perfect for small clinics getting started with AI-powered healthcare management.', '["Up to 500 patients", "AI-powered intake forms", "Basic appointment scheduling", "Email support", "1 practitioner"]', 1, 500, true, 0),
('Starter', 'starter-yearly', 50000, 'PHP', 'yearly', 'Perfect for small clinics getting started with AI-powered healthcare management.', '["Up to 500 patients", "AI-powered intake forms", "Basic appointment scheduling", "Email support", "1 practitioner"]', 1, 500, true, 1),
('Professional', 'professional', 10000, 'PHP', 'monthly', 'For growing clinics that need advanced AI features and team management.', '["Up to 2,000 patients", "Advanced AI features", "Smart scheduling & reminders", "Priority support", "Analytics dashboard", "Up to 5 practitioners", "Secure messaging"]', 5, 2000, true, 2),
('Professional', 'professional-yearly', 100000, 'PHP', 'yearly', 'For growing clinics that need advanced AI features and team management.', '["Up to 2,000 patients", "Advanced AI features", "Smart scheduling & reminders", "Priority support", "Analytics dashboard", "Up to 5 practitioners", "Secure messaging"]', 5, 2000, true, 3),
('Enterprise', 'enterprise', 25000, 'PHP', 'monthly', 'For large clinics and multi-location practices with custom needs.', '["Unlimited patients", "Full AI suite", "Custom integrations", "Dedicated support", "Advanced analytics", "Unlimited practitioners", "Multi-location support", "API access"]', NULL, NULL, true, 4),
('Enterprise', 'enterprise-yearly', 250000, 'PHP', 'yearly', 'For large clinics and multi-location practices with custom needs.', '["Unlimited patients", "Full AI suite", "Custom integrations", "Dedicated support", "Advanced analytics", "Unlimited practitioners", "Multi-location support", "API access"]', NULL, NULL, true, 5)
