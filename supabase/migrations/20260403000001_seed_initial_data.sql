...
-- Subscription Plans
INSERT INTO public.subscription_plans (name, slug, price, currency, billing_cycle, description, features, max_practitioners, max_patients, max_branches, is_active, sort_order) VALUES
('Starter', 'starter', 5000, 'PHP', 'monthly', 'Perfect for small clinics getting started with AI-powered healthcare management.', '["Up to 500 patients", "AI-powered intake forms", "Basic appointment scheduling", "Email support", "Up to 3 practitioners", "1 location"]', 3, 500, 1, true, 0),
('Starter', 'starter-yearly', 50000, 'PHP', 'yearly', 'Perfect for small clinics getting started with AI-powered healthcare management.', '["Up to 500 patients", "AI-powered intake forms", "Basic appointment scheduling", "Email support", "Up to 3 practitioners", "1 location"]', 3, 500, 1, true, 1),
('Professional', 'professional', 10000, 'PHP', 'monthly', 'For growing clinics that need advanced AI features and team management.', '["Up to 2,000 patients", "Advanced AI features", "Smart scheduling & reminders", "Priority support", "Analytics dashboard", "Up to 5 practitioners per branch", "Up to 3 branches", "Secure messaging"]', 5, 2000, 3, true, 2),
('Professional', 'professional-yearly', 100000, 'PHP', 'yearly', 'For growing clinics that need advanced AI features and team management.', '["Up to 2,000 patients", "Advanced AI features", "Smart scheduling & reminders", "Priority support", "Analytics dashboard", "Up to 5 practitioners per branch", "Up to 3 branches", "Secure messaging"]', 5, 2000, 3, true, 3),
('Enterprise', 'enterprise', 25000, 'PHP', 'monthly', 'For large clinics and multi-location practices with custom needs.', '["Unlimited patients", "Full AI suite", "Custom integrations", "Dedicated support", "Advanced analytics", "Unlimited practitioners", "Unlimited branches", "API access"]', NULL, NULL, NULL, true, 4),
('Enterprise', 'enterprise-yearly', 250000, 'PHP', 'yearly', 'For large clinics and multi-location practices with custom needs.', '["Unlimited patients", "Full AI suite", "Custom integrations", "Dedicated support", "Advanced analytics", "Unlimited practitioners", "Unlimited branches", "API access"]', NULL, NULL, NULL, true, 5)
